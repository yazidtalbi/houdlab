...
export default function AdminPanel() {
  ...
  const [userTyping, setUserTyping] = useState(false); // ← user typing
    ...
    const ch = supabaseBrowser
      ...
      .on(
        ...
        (payload) => {
          ...
          // if user sent a message, stop their typing indicator
    ...
    <div className="h-screen grid grid-cols-12">
      ...
      <div className="col-span-8 flex flex-col">
        ...
        <div ref={listRef} className="flex-1 overflow-y-auto p-4 bg-neutral-50">
          ...
          {/* Typing bubble appears after the last message */}
          {userTyping && (
